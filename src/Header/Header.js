                    ...
                    {isLoggedIn ? (
                        <div className='navBar_menus'>
                            ...
                            <div className='center-menus'>
                                <div className="navBar_menus_menu"><NavLink to ='/upload/2' className='text-link'>Post a product</NavLink></div>
                                <div className="navBar_menus_menu"><NavLink to ='/product2/3' className='text-link'>Product</NavLink></div>
                                <div className="navBar_menus_menu"><NavLink to ='/comunity/4' name='comunity' className='text-link'>Community</NavLink></div>
                                <div className="navBar_menus_menu"><NavLink to ='/cart/5' className='text-link'>Shopping Basket</NavLink></div>
                            </div>
                        ...
                        <div>
                            <div className="navBar_menus">
                                <div className='start-menu'><NavLink to ='/' className='text-link'><h1 className='navBar_main'>PetShop</h1></NavLink></div>
                                <div className='center-menus'>
                                    <div><NavLink to ='/product2/3' className='text-link'>Product</NavLink></div>
                                    <div><NavLink to ='/cart/5' className='text-link'>Shopping Basket</NavLink></div>
                                </div>
                                {/* <li>{init ? <Router isLoggedIn={isLoggedIn} /> : '!'}</li> */}
                                <div className='end-menus'>
                                    <div><NavLink to="/login" className='text-link'>login</NavLink></div>
                                    <div><NavLink to="/signup" className='text-link' >Sign Up</NavLink></div>
                                </div>
                            </div>
                        </div>
                    )}
